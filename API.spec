...
paddle.fluid.layers.sampled_softmax_with_cross_entropy ArgSpec(args=['logits', 'label', 'num_samples', 'remove_accidental_hits', 'seed'], varargs=None, keywords=None, defaults=(True, 0))
...
paddle.fluid.layers.gelu ArgSpec(args=['x', 'name'], varargs=None, keywords=None, defaults=(None,))
